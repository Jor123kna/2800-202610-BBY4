...
// For the disaster list on the Info page, we only need the summary info (id, icon, name, description, colorClass)
export const disasters = Object.values(disasterDetails).map((disaster) => ({
  id: disaster.id,
  icon: disaster.icon,
  name: disaster.name,
  description: disaster.description,
  colorClass: disaster.colorClass,
}));
